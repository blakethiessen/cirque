...
public class TextRender extends Component
{
    ...
    public TextRender(String text, Vector2 position, Color color, float alignmentSize, BitmapFont.HAlignment alignment)
    {
        this.text = text;
    ...
    {
        this(text, position, Color.BLACK, 0, BitmapFont.HAlignment.CENTER);
    }
